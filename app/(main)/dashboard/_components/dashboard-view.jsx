    ...
    return (
        <div className="space-y-6">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
                {/* Top 4 Insight Cards */}
                <Card className="rounded-sm bg-background/80">
                ...
                <Card className="rounded-sm bg-background/80">
                    <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
                        ...
                        <BriefcaseIcon className="text-2xl font-bold" />
                    </CardHeader>
                    <CardContent>
                ...
                <Card className="rounded-sm bg-background/80">
                    <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
                        ...
                        <Brain className="text-2xl font-bold" />
                    </CardHeader>
                    <CardContent>
                ...
                <Card className="rounded-sm bg-background/80 w-full col-span-1 md:col-span-2 lg:col-span-4 mt-2">
                    <CardHeader>
                ...
                <Card className="rounded-sm bg-background/80 w-full col-span-1 md:col-span-2 mt-2">
                    <CardHeader>
